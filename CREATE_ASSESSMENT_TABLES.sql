...
-- 1. Assessments table (created by trainers)
...
-- 3. Answer options table (for multiple choice questions)
...
-- 4. Assessment attempts table (learner submissions)
...
-- Uncomment to insert test assessment

/*
-- Insert a sample assessment
INSERT INTO assessments (course_id, title, description, passing_score, time_limit_minutes, is_required, status)
VALUES (
  '14c9399b-d8b1-47ea-8023-e3867a50cb42', -- Replace with your course ID
  'Financial Literacy Basics Quiz',
  'Test your understanding of fundamental financial concepts',
  70,
  30,
  true,
  'published'
...
-- Get the assessment ID from above and insert questions
...
-- Success message
SELECT 'Assessment system tables created successfully!' as status;
