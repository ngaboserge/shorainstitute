    ...
    <div className="auth-page">
      <div className="auth-container">
        ...
        <div className="role-switcher">
          <Link to="/auth/learner/signup" className="role-btn active">
            Learner
          </Link>
          <Link to="/auth/trainer/signup" className="role-btn">
            Trainer
          </Link>
          <Link to="/auth/institutional/signup" className="role-btn">
            Institution
          </Link>
        </div>
        ...
        <div className="auth-footer">
          <p>
            ...
            <Link to="/auth/learner/login">Login here</Link>
          </p>
          <p className="switch-role">
            Want to teach instead?{' '}
            <Link to="/auth/trainer/signup">Sign up as Trainer</Link>
          </p>
        </div>

        <div className="auth-benefits">
          <h3>Why learn with SHORA?</h3>
          <ul>
            <li>✓ Access thousands of expert-led courses</li>
